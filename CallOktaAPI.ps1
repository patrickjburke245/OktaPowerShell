...
function Get-OktaSession($sessionid) {
    Invoke-Method GET "/api/v1/sessions/$sessionid"
}

#Get-OktaSession "102Hq76tYDfRk6y66RBkeOX6A"

function Get-RolesAssignedToUser($userid) {
    Invoke-Method GET "/api/v1/$userid/roles"
}

Get-OktaRoles "00ufqe09pWOw5498Z3l6"

function Get-RolesAssignedToGroup($groupid) {
    Invoke-Method GET "/api/v1/$groupid/roles"
}

#Get-RolesAssignedToGroup "00ggwqx9gAlvvmMM63l6"
#Get-OktaFactor "00ufqe09pWOw5498Z3l6"

function Get-Clients() {
    Invoke-Method GET "/oauth2/v1/clients"
}

#Get-Clients
<# function New-Client($clientName, $clientUri, $logoUri, $applicationType, $redirectUris, $postLogoutRedirectUris, $responseTypes,
    $grantTypes, $tokenEndpointAuthMethod, $initiateLoginUri) {

    Invoke-Method POST "/oauth2/v1/clients"
    ConvertTo-Json -InputObject $Body
}

#Creating a dummy oauth2 client
$clientName = "Spiderman App"
$clientUri = "https://localhost:8080"
$logoUri = "https://localhost:8080/logo.png"
$applicationType = "web"
$redirectUris = @("https://localhost:8080/oauth2/callback")
$postLogoutRedirectUris = @("https://localhost:8080")
$responseTypes = @("code"; "token")
$grantTypes = @("authorization_code"; "refresh_token")
$tokenEndpointAuthMethod = "client_secret_post"
$initiateLoginUri = "https://localhost:8080/oauth2/login"
...
New-Client @{body = $body}

function New-OktaClient($client) {
    Invoke-Method POST "/oauth2/v1/clients" $client
}
# Create an oauth2 client.
$client = @{
    client_name = "Spiderman App"
    client_uri = "https://localhost:8080"
    logo_uri = "https://localhost:8080/logo.png"
    application_type = "web"
    redirect_uris = @("https://localhost:8080/oauth2/callback")
    post_logout_redirect_uris = @("https://localhost:8080")
    response_types = @("code")
    grant_types = @("authorization_code", "refresh_token")
    token_endpoint_auth_method = "client_secret_post"
    initiate_login_uri = "https://localhost:8080/oauth2/login"
}
New-OktaClient $client #>
